...
const vapi = new Vapi("aa252653-8e48-463e-b5dc-91e5cd1a039a"); // Public Key

const assistantId = "4f84d769-80af-4770-8847-b7fd0c5be67b"; // Assistant ID for VerhuizerAI
