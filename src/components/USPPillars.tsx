...
const pillars = [
    {
        ...
        pillarLinks: [{ href: "/voice-ai", anchor: "ai telefonist voor verhuisbedrijven" }, { href: "/chatbot", anchor: "ai chatbot voor verhuisbedrijven" }],
    },
    {
        ...
        icon: <FiStar size={32} />,
        pillarLinks: [{ href: "/seo", anchor: "seo voor verhuisbedrijven" }, { href: "/reviews", anchor: "review management voor verhuisbedrijven" }],
    },
    {
        ...
        pillarLinks: [{ href: "/automatisering", anchor: "workflow automatisering voor verhuizers" }, { href: "/crm", anchor: "crm voor verhuisbedrijven" }],
    },
    {
        ...
        pillarLinks: [{ href: "/gratis-website", anchor: "gratis website voor verhuisbedrijven" }],
    }
];
