...
const FallingText = () => {
    ...
    useEffect(() => {
        ...
        const allWords = [
            ...
            "Meer Omzet per Verhuizing 🚚",
            "Alles-in-1 Systeem 📱",
            "Nooit Meer Gemiste Aanvragen 📅",
            "Je Rittenplanning op Orde 🗺️",
            ...
            // VERHUIZER PUNS & FUN
            "Minder tillen, meer verdienen 🏋️",
            "Tijd voor koffie & verhuisdozen ☕",
            "Laat de telefoon maar rinkelen (AI pakt op) 📞",
            "Laat de AI je agenda vullen 🤖",
            "Dozen sjouwen, niet telefoneren 📦",
            "Geen rommel in je planning 📅",
            "Verhuizen met stijl, AI doet de rest 🎩",
            "Jij de spieren, AI het werk 🤖",
            "Van verhuizer naar top-ondernemer 🚀",
            "Rug kapot? AI helpt je verder 💪",
            "Meer ritten in minder tijd ⏳",
            "Altijd on time, net als je busje 🚛",
