...
const niche = siteDetails.niche?.toLowerCase() || "verhuizers";
...
const workflows = [
  ...
  },
  {
    ...
    desc: `Klantspecifieke onderhoud- of opvolg-cycli automatisch beheerd. Voor Verhuizers: automatische offerte-aanvraag flow via chatbot, verhuisdag-bevestiging via WhatsApp, post-verhuizing review-verzoek — terugkerende omzet zonder dat jij eraan hoeft te denken.`,
  },
];
...
const integrations = [
  { icon: BsWhatsapp, title: "WhatsApp Business", desc: "Het hoofdkanaal — 90% van verhuizers-klanten checkt WhatsApp sneller dan e-mail." },
      ...
      <section className="py-12 md:py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            maar wel volle agendas willen. Jij verhuist, wij regelen de rest.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
