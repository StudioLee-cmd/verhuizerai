...
export const voiceDemos: VoiceDemoOpname[] = [
    {
        ...
        richting: 'Iemand vraagt een offerte voor een verhuizing; de agent vraagt door op woonoppervlak, etage en of er een lift is, en plant de opname in.',
        stem: 'Thomas',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Een klant wil de verhuisdatum een week opschuiven omdat de sleuteloverdracht is uitgelopen.',
        stem: 'Sanne',
        src: null,
        duur: null,
    },
    {
        ...
        richting: 'Iemand vraagt ’s avonds wat een verhuizing mét opslag kost en of er in het weekend nog een datum vrij is.',
        stem: 'Eva',
        src: null,
        duur: null,
    },
